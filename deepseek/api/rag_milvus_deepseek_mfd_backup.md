...
```
    ...
    [1mBertModel LOAD REPORT[0m from: BAAI/bge-small-zh-v1.5
    Key                     | Status     |  | 
    ------------------------+------------+--+-
...
```
    ...
    插入数据: 100%|██████████| 387/387 [00:00<00:00, 376262.32it/s]
...
```
    ...
    回答:
    ------------------------------------------------------------
    中华人民共和国民法典第205条规定：“本编调整因物的归属和利用产生的民事关系。”
    ------------------------------------------------------------
